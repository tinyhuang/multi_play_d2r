...
rem  - 窗口位置/大小默认根据 base_settings 中的布局规则自动分配；需要自定义时再在下方写 ACC*_windowX/Y/W/H
rem -------------------------------------------------------
...
if not exist "%accounts_file%" (
    echo [ERROR] 未找到账号密钥文件: %accounts_file%
    echo 请创建 config\accounts_secrets.bat（可参考 config\accounts_secrets_example.bat）并填入账号信息。
    exit /b 1
)
call "%accounts_file%"
...
set "ACC1_message=大号亚马逊，第一个完?1111111111111111111111111111111111111"

set "ACC2_enabled=1"
set "ACC2_mod=MDK"
set "ACC2_launchArgs="
set "ACC2_windowName=two"
set "ACC2_message=大号法师、圣骑士、男?第二个完?22222222222222222222222222222222222222222222222222222222222"

set "ACC3_enabled=1"
set "ACC3_mod="
set "ACC3_launchArgs="
set "ACC3_windowName=three"
set "ACC3_message=大号，刺客、打宝野蛮人，第三个完事33333333333333333333333333333333333333333333"

set "ACC4_enabled=1"
set "ACC4_mod="
set "ACC4_launchArgs="
set "ACC4_windowName=four"
set "ACC4_message=小号 德鲁? 第四个完?44444444444444444444444444444444444444444444444444444444"

set "ACC5_enabled=1"
set "ACC5_mod="
set "ACC5_launchArgs="
set "ACC5_windowName=five"
set "ACC5_message=小号，野蛮人，第五个完事555555555555555555555555555555555555555555"

set "ACC6_enabled=1"
set "ACC6_mod="
set "ACC6_launchArgs="
set "ACC6_windowName=six"
set "ACC6_message=小号，新法师666666666666666666666666666666666"

set "ACC7_enabled=1"
set "ACC7_mod="
set "ACC7_launchArgs="
set "ACC7_windowName=seven"
set "ACC7_message=- - - - - - - SOR, PAL is READY - - - - - - - -"

set "ACC8_enabled=1"
set "ACC8_mod="
set "ACC8_launchArgs="
set "ACC8_windowName=eight"
set "ACC8_message=- - - - - - - SOR, PAL is READY - - - - - - - -"
rem -------------------账号配置结束------------------------
...
echo 启动账号: !username! (mod: !mod!)
start "" "%diablo%" -username !username! -password !password! -address "%addres%" !modSwitch! !launchSwitch!
